...
It seems that you were injected by some weird liquid.
You are infected.
...
After adding a bonus point, if you still have some remaining points, you can attempt to view or edit your information to continue adding.
